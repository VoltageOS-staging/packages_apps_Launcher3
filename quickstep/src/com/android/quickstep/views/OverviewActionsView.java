...
public class OverviewActionsView<T extends OverlayUICallbacks> extends FrameLayout
    ...
    public OverviewActionsView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mPrefs = LauncherPrefs.getPrefs(appContext);
        mScreenshot = LauncherPrefs.RECENTS_SCREENSHOT.get(appContext);
        mClearAll = LauncherPrefs.RECENTS_CLEAR_ALL.get(appContext);
        mLens = LauncherPrefs.RECENTS_LENS.get(appContext);
    }
