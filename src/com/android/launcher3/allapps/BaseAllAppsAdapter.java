...
public abstract class BaseAllAppsAdapter<T extends Context & ActivityContext> extends
    ...
    public BaseAllAppsAdapter(T activityContext, LayoutInflater inflater,
        ...
        if (LauncherPrefs.ALL_APPS_DARK_TEXT.get(activityContext)) {
            mTextColor = activityContext.getResources().getColor(
                    R.color.all_apps_label_color_dark_forced, null);
       } else {
            mTextColor = Themes.getAttrColor(activityContext, R.attr.workspaceTextColor);
        }
